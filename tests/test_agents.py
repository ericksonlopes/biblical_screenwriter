...
class TestYouTubeDetailAgent:
    ...
    def test_gerar_detail_video_youtube_sucesso(self, mock_save_sqlite, mock_agent, sample_detail_video, sample_roteiro):
    ...
    @patch('src.agents.youtube_detail_agent.agent')
    @patch('src.agents.youtube_detail_agent.save_info_video_sqlite')
    def test_gerar_detail_video_youtube_sem_roteiro_id(self, mock_save_sqlite, mock_agent, sample_detail_video, sample_roteiro):
    ...
    @patch('src.agents.youtube_detail_agent.agent')
    @patch('src.agents.youtube_detail_agent.save_info_video_sqlite')
    def test_gerar_detail_video_youtube_prompt_completo(self, mock_save_sqlite, mock_agent, sample_detail_video, sample_roteiro):
